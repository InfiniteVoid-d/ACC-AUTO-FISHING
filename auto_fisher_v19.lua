-- =============================================
-- Auto Fisher v19 - Customizable Struggle Threshold
...
local Config = {
    ...
    InstantCatchDelay = 0.55,     -- Default delay matching "Super Instant Delay" (0.55s)
    SlowReelThreshold = 0.91,     -- Target struggle percentage (default 91% or 0.91)
    
    BlatantRecastDelay = 0.05,   -- Fast recast delay
...
local originalHeight = 235 -- Increased to accommodate two input boxes
...
delayInputBox.PlaceholderText = "0.55"
...
-- =============================================
-- INPUT BOX 2: SLOW REEL THRESHOLD (NEW)
-- =============================================
...
local function updateModeUI()
    ...
    local showThreshold = isBlatant and (Config.BlatantStrategy == "instant")
    ...
    if isBlatant then
        ...
        if s == "instant" or s == "blatant" then
            inputLabel.Text = s == "instant" and "Instant Catch Delay (s):" or "Catch Delay / Cast Spam (s):"
            delayInputBox.Text = tostring(Config.InstantCatchDelay)
...
-- =============================================
-- SLOW REEL THRESHOLD INPUT LOGIC
-- =============================================
...
-- =============================================
-- PURE BLATANT CAST/CATCH SPAM LOOP
-- =============================================
local function startBlatantLoop()
    ...
    blatantThread = task.spawn(function()
        while autoFishing and Config.BlatantStrategy == "blatant" do
            ...
            -- Wait the adjustable catch delay before claiming catch
            task.wait(Config.InstantCatchDelay)
