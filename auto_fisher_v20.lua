-- =============================================
-- Auto Fisher v20 - Pipelined Blatant Strategy
...
local function startBlatantLoop()
    ...
    blatantThread = task.spawn(function()
        while autoFishing and Config.BlatantStrategy == "blatant" do
            ...
            -- Spawn a delayed catch thread for this specific cast
            task.spawn(function()
                task.wait(Config.InstantCatchDelay) -- Wait the struggle delay (e.g. 1.5s)
            ...
            -- Wait the casting spam interval
            task.wait(Config.BlatantRecastDelay) -- e.g. 0.3s between casts
        end
    end)
end
